...
#start uac
kubectl exec -i $uac -n default -- bash -c "cd /home/sipp/sipp-3.4.1 && ./sipp -sf uac_mod.xml $opensips_ip:5060 -trace_screen -s chetan -i $uac_ip -p 5065  -m 100 -r 10 -rp 1000 >/dev/null 2>&1 &" ; 
kubectl exec -i $uac -n default -- bash -c "cd /home/sipp/sipp-3.4.1 && echo $?" ;
