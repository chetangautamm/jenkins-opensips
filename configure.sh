...
#start uac
kubectl exec -i -t $uac -n default -- bash -c "cd /home/sipp/sipp-3.4.1/ && nohup ./sipp -sf uac_mod.xml $opensips_ip:5060 -trace_screen -s chetan -i $uac_ip -p 5065  -m 100 -r 10 -rp 1000 > screen.out 2> screen.err &"
